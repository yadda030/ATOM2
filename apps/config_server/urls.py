...
urlpatterns = [
    ...
    path('scripts/raw/<str:identifier>/', views.serve_script_raw, name='serve_script_raw'),  # ← move to top
    ...
    path('scripts/<int:pk>/export/', views.script_export, name='script_export'),
